...
int main()
{
	...
	if (!in_file) {
		...
		cout << "Text file has been encrypted! New encrypted file created" << endl << endl;
	}
	...
	if (!i_file) {
		...
		cout << "Read file has been opened!" << endl << endl;
	}
	...
	if (!o_file) {
		...
		cout << "Write file has been opened!" << endl << endl;
	}
